        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <motion.div 
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand text-white w-32 h-32 rounded-full flex flex-col items-center justify-center shadow-2xl border-4 border-brand-light z-10"
            >
              <span className="text-3xl font-serif font-bold">Premium</span>
              <span className="text-xs uppercase tracking-widest mt-1">Dining</span>
            </motion.div>
          </div>
          ...
          <div>
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h4 className="text-brand font-medium tracking-widest uppercase mb-2">Our Story</h4>
              <h2 className="text-4xl md:text-5xl font-serif text-brand-dark mb-6">A Journey of Taste and Elegance</h2>
