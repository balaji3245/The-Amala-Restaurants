          ...
          {images.map((src, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <span className="text-white font-medium border border-white px-6 py-2 rounded-full uppercase tracking-wider text-sm hover:bg-white hover:text-brand-dark transition-colors">
                  View
                </span>
              </div>
            </motion.div>
