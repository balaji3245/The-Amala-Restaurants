      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-auto md:h-[600px]">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-2 md:row-span-2 bento-card p-2"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-1 md:row-span-1 bento-card p-2"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-1 md:row-span-2 bento-card p-2"
          >
